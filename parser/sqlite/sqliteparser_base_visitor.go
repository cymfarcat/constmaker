...
func (v *BaseSQLiteParserVisitor) VisitDocComment(ctx *DocCommentContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseSQLiteParserVisitor) VisitTripleComment(ctx *TripleCommentContext) interface{} {
	return v.VisitChildren(ctx)
}
