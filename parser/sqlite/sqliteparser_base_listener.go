...
func (s *BaseSQLiteParserListener) EnterDocComment(ctx *DocCommentContext) {}

// ExitDocComment is called when production docComment is exited.
func (s *BaseSQLiteParserListener) ExitDocComment(ctx *DocCommentContext) {}

// EnterTripleComment is called when production tripleComment is entered.
func (s *BaseSQLiteParserListener) EnterTripleComment(ctx *TripleCommentContext) {}

// ExitTripleComment is called when production tripleComment is exited.
func (s *BaseSQLiteParserListener) ExitTripleComment(ctx *TripleCommentContext) {}
