...
func (obj *ConstParser) genText(option *ConstOption) {
...
func (obj *Object) genText(prefix string, option *ConstOption, builder *strings.Builder) {
	for idx, constObj := range obj.Children {
		...
		if constObj.objType == TypeEnumValue && !(obj.enumToPrefix || option.enumToPrefix) {
			if obj.enumSetValue {
				str = "\n" + option.getTabWidth() + option.genIdentNameObj(prefix, constObj) + ": " + textTypo(constObj.Typo) + " = " + constObj.Value
			} else {
				str = "\n" + option.getTabWidth() + option.genIdentNameObj(prefix, constObj) + ": " + textTypo(constObj.Typo) + " = " + constObj.Value
			}
		} else {
...
func (obj *Object) genTextStr(prefix string, option *ConstOption, builder *strings.Builder) {
...
func (obj *Object) genTextId(prefix string, option *ConstOption, builder *strings.Builder) {
	for _, constObj := range obj.genObjs {
 ...
 */
func (obj *NameSpace) genText(option *ConstOption, builder *strings.Builder) {
	namespace := option.genIdentNameObj("", &obj.Object)
	...
	obj.Object.genText(option.getPrefixes(""), option, builder)
